...
design_df[which(design_df$ID == TEST_CASE & design_df$CKMR == "Yes" & design_df$Value == "Est"),7:13] <- as.numeric(interesting_stuff(ptru, lglk_with_data))
...
design_df[design_df$ID == TEST_CASE & design_df$CKMR == "Yes" & design_df$Value == "SE",7:13] <- as.numeric(basic0)
...
design_df[design_df$ID == TEST_CASE & design_df$CKMR == "No" & design_df$Value == "SE",7:13] <- as.numeric(basic0_noCK)
...
design_df[design_df$ID == TEST_CASE & design_df$CKMR == "Yes" & design_df$Value == "CV",7:13] <- cvs_yes
design_df[design_df$ID == TEST_CASE & design_df$CKMR == "No" & design_df$Value == "CV",7:13] <- cvs_no
